...
dataset = load_dataset("anhaltai/inaturalist-300k", use_auth_token=True, num_proc=16)
dataset = dataset.remove_columns(["image", "decimalLatitude", "decimalLongitude", "creator", "references"])
...
for split_name in dataset.keys():
    ...
    df_groups.to_csv(f"inaturalist-300k.{split_name}.csv", encoding="utf-8")
